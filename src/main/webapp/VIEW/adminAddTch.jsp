...
<div class="container" id="mainCon">
    ...
    <ul class="nav nav-pills" id="mainNav">
        ...
        <li class="active"><a href="/adminAddTch">添加教师</a></li>
        <li><a href="/adminTchManage">教师管理</a></li>
    </ul>

    <div class="well well-sm">
        <form class="form-horizontal" enctype="multipart/form-data" action="/addTeacher" method="post">
            <fieldset>
                <legend>添加教师</legend>
                <div class="form-group">
                    <label for="userName" class="col-md-2 control-label">教师姓名</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="userName" name="userName">
                    </div>
                </div>
                <div class="form-group">
                    <label for="userNum" class="col-md-2 control-label">职工卡号</label>
                    <div class="col-md-10">
                        <input type="number" class="form-control" id="userNum" name="userNum">
                    </div>
                </div>
                <div class="form-group">
                    <label for="userCollege" class="col-md-2 control-label">教师院系</label>
                    <div class="col-md-10">
