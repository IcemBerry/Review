...
<head>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/customize/tchDownload.js"></script>
...
<div class="container" id="mainCon">
    ...
    <ul class="nav nav-pills" id="mainNav">
        ...
        <li class="active"><a href="/tchDownload">交付物下载</a></li>
        <li><a href="/tchReview">成绩审核</a></li>
    </ul>

    <table id="tchDownTable"></table>
